# Nilai dan penilaian (grades & assessment)

## Purpose

Mencatat **nilai** per **Siswa** dalam konteks **Kelas**, **BidangStudi**, **tahun ajaran**, dan **komponen penilaian**, dengan aturan akses, validasi anggota kelas, dan jejak audit selaras modul akademik.
