# Platform: identity, access & audit

## Purpose

Menjamin otentikasi, RBAC, administrasi pengguna minimal, dan audit trail sebagai fondasi keamanan Studia Center (selaras PRD).
