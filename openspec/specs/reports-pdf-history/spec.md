# Laporan PDF dan riwayat (reports PDF & history)

## Purpose

Menyediakan **generasi berkas PDF** untuk konteks **kelas** (nilai, presensi), **riwayat** metadata generasi/unduhan, kontrol akses selaras modul akademik, dan jejak audit.
