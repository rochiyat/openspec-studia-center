...
Sistem SHALL menyediakan pengelolaan **Kelas** dengan kode unik, nama, tahun ajaran, dan referensi **Level** wajib; referensi **Tentor** dan **Ruang** opsional sesuai implementasi.
...
#### Scenario: Daftar kelas

- **WHEN** pengguna terotentikasi meminta daftar kelas
