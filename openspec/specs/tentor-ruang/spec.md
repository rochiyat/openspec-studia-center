...
Master **Tentor** (pengajar) dan **Ruang** belajar dengan kode unik; tentor dapat ditautkan ke paling banyak satu akun **User** untuk menyelaraskan identitas login dengan profil pengajar, sebagai referensi untuk jadwal, kelas, dan modul akademik berikutnya.
