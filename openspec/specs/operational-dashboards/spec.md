# Dashboard operasional (operational dashboards)

## Purpose

Menyediakan **ringkasan agregat numerik** operasional (read-only) untuk peran institusi dan **halaman web** yang menampilkan metrik tersebut, tanpa mengubah alur CRUD domain existing.
